...
class _MatchesMobilePageState extends State<MatchesMobilePage> {
  ...
  void startGames() {
    ...
    setState(() {
      listaDeCombinacoes = dataProvider.listaDeCombinacoes;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () => dataProvider.addRoundManually(context),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            if(partidas[index].vencedor != null)
                                              ElevatedButton(
                                                onPressed: () {
                                                  final random = Random().nextInt(playersBySide);
                                                  final random2 = Random().nextInt(playersBySide);
      ...
      floatingActionButton: (_admin ?? false)
        ? FloatingActionButton(onPressed: () => dataProvider.addRoundManually(context), child: const Icon(Icons.add),)
        : null
    );
  }
}
